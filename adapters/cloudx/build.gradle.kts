...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/cloudx-xenoss/cloudexchange.android.adapter-cloudx")
            connection.set("scm:git:git://github.com/cloudx-xenoss/cloudexchange.android.adapter-cloudx.git")
            developerConnection.set("scm:git:ssh://git@github.com/cloudx-xenoss/cloudexchange.android.adapter-cloudx.git")
        }
    }
}
